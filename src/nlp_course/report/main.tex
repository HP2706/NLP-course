...
% What is the performance of your classifier for each of the languages Finnish, Japanese and Russian?
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.8\textwidth]{../week1/plots/week1_c_scatter_fi.png}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.8\textwidth]{../week1/plots/week1_c_scatter_ja.png}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.8\textwidth]{../week1/plots/week1_c_scatter_ru.png}
    ...
    %%  japanese 0.3684210526315789, 'f1': 0.03355704697986577, 'precision': 1.0, 'recall': 0.017064846416382253
