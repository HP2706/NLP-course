...
\begin{enumerate}
    ...
    In the appendix, we provide scatter plots for each language. See Figure Appendix~\ref{fig:scatter_week1_c_fi}, \ref{fig:scatter_week1_c_ja}, and \ref{fig:scatter_week1_c_ru} show the scatter plots for Finnish, Japanese, and Russian data respectively.
...
we make the hypothesis that the low amount of training data(100 samples per language) makes it hard for the model to learn the language specific patterns. 
